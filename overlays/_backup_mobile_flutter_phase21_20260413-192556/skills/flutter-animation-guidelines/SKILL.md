...
Animation rules for tasteful transitions, implicit/explicit animations, performance, and reduced-motion awareness.

## When to use

Use this skill when the task directly involves **animation rules**.
