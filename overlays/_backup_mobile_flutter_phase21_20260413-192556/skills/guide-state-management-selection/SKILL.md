...
Decision framework for choosing Riverpod, GetX, ValueNotifier, Bloc, or plain setState by project constraints.

## When to use

Use this skill when the task directly involves **decision framework**.
