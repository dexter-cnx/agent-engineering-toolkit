...
Rules enforcing dependencies: presentation depends on domain, data implements domain, widgets stay thin.

## When to use

Use this skill when the task directly involves **rules enforcing dependencies: presentation depends on domain, data implements domain, widgets stay thin.**.
