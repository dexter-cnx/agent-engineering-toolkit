...
Architecture-focused coordinator for feature boundaries, dependency rules, modularization, and app structure.

## When to use

Use this skill when the task directly involves **architecture-focused coordinator**.
