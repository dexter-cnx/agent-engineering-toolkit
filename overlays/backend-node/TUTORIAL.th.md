...
## สถานการณ์
เพิ่ม endpoint สำหรับ user preferences ใน Node backend โดยไม่ให้ transport, business logic และ provider calls ไหลมารวมกันในชั้นเดียว

## ขั้นตอนทีละขั้น
1. เริ่มจากโครงสร้างใน `README.md`
2. อ่าน `AGENTS.overlay.md` เพื่อยืนยันกฎ boundary
3. ใช้ `examples/worked_example.md` เพื่อดูรูปแบบ layering ที่คาดหวัง
4. ให้ transport อยู่เฉพาะใน routes
