...
Minimum test expectations per feature including unit, widget, and critical-path integration coverage.

## When to use

Use this skill when the task directly involves **minimum test expectations per feature including unit, widget, and critical-path integration coverage.**.
