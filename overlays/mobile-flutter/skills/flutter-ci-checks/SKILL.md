...
CI blueprint for format, analyze, test, build, and structure enforcement in Flutter repositories.

## When to use

Use this skill when the task directly involves **ci blueprint**.
