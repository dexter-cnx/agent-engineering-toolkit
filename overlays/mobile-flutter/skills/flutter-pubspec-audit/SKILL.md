...
Audit checklist for pubspec hygiene, asset correctness, dependency pinning, and package sprawl.

## When to use

Use this skill when the task directly involves **audit checklist**.
