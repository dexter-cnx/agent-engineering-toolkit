...
Step-by-step workflow for building a feature with presentation, domain, data, DTO, mapper, and tests.

## When to use

Use this skill when the task directly involves **step-by-step workflow**.
