...
- Run `flutter analyze` and check for router errors in the output — confirm no path conflicts
- Run `adb shell am start -W -a android.intent.action.VIEW -d "<uri>"` — confirm correct screen opens
