...
## มันคืออะไร
นี่คือเส้นทางอ้างอิงสำหรับการสร้าง frontend แบบ Next.js กับ backend แบบ ASP.NET Core โดยใช้ระบบ overlay แบบโมดูลาร์
...
4. ทำ JWT และ refresh flow ใน `backend-dotnet`
...
4. ทำ EF Core และ validation ใน `backend-dotnet`
...
- ตรวจว่า detail เฉพาะ ASP.NET Core อยู่ใน backend-dotnet เท่านั้น
