...
## มันคืออะไร
นี่คือเส้นทางอ้างอิงสำหรับการสร้าง frontend แบบ Next.js คู่กับ backend แบบ Python service โดยใช้ระบบ overlay แบบโมดูลาร์
...
4. ทำ token/session หรือ worker-safe auth flow ใน `python-service`
...
4. ทำ routers, services, repositories และ adapters ใน `python-service`
...
- ตรวจว่า detail เฉพาะ Python service อยู่ใน python-service เท่านั้น
